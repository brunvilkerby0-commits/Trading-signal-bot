...
// 🛑 TI REPONS KOUT POU CRON-JOB.ORG (Evite "sortie trop grande")
app.get('/', (req, res) => {
...
function checkAndSendSignal() {
    ...
    // 1. BLOKAJE WIKENN: Si se Samdi (6) oswa Dimanch (0)
    ...
    // 3. SESYON MATEN: 9:00 AM rive 12:00 PM -> Maks 3 siyal
    ...
    // 4. SESYON ASWÈ: 9:00 PM rive 12:00 AM -> Maks 3 siyal
    ...
    // Kalkile Lè pou antre a (+35 segonn entèn)
